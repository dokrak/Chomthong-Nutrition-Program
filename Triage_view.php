...
$query_triagent = sprintf("SELECT * FROM triagent WHERE hosp=%s and Tdate>=%s and Tdate <=%s order by ward,score DESC ", GetSQLValueString($hosp1_triagent, "text"),GetSQLValueString($Sdate_triagent, "date"),GetSQLValueString($Edate_triagent, "date"));
...
<body>
<p align="center">แสดงผลการคัดกรองความเสี่ยงต่อภาวะทุพโภชนาเบื้องต้น โรงพยาบาล 
