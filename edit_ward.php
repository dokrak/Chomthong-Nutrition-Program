...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE department SET dptname=%s , hid=%s where id=%s",
  						GetSQLValueString($_POST['id'], "int"),
                       GetSQLValueString($_POST['dptname'], "text"),
...
mysql_select_db($database_hospital, $hospital);
$query_Recordset1 = sprintf("SELECT * FROM department WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <th width="54%" bgcolor="#B4ED78" scope="col"><span style="text-shadow:#C33; background-color: #D8F2B8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;แก้ไขข้อมูลหน่วยบริการ
    ...
    <td height="218" colspan="3"><form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
        <table align="center">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="Fname" value="<?php echo htmlentities($row_Recordset1['dptname'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Lname:</td>
            <td><input type="text" name="Lname" value="<?php echo htmlentities($row_Recordset1['hid'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
          </tr>
